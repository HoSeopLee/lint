...
npm install -D @hoseop/lint@1 eslint@9 typescript@5

# ESLint 10 / TypeScript 6.0 프로젝트
npm install -D @hoseop/lint@2 eslint@10 typescript@~6.0.2
```
...
Next 프로젝트에서는 import 경로를 `@hoseop/lint/next`로 바꿉니다. package.json에 `"type": "module"`이 없다면 설정 파일 이름은 `eslint.config.mjs`로 사용합니다.
