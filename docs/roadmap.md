...
하나의 npm 패키지 `@broccoil/lint`를 1.x와 2.x로 분리해 배포하고, 각 브랜치에서 설치·수정·테스트·후속 배포를 이어갈 수 있게 합니다.

**1차 목표 완료 — 2026-09-22.** `1.0.0`과 `2.0.0`을 게시하고 npm 태그·Git 태그·실제 pnpm 설치를 확인했습니다. 각 브랜치의 개발 환경과 CI를 갖췄으며, 상세 결과는 [배포 검증 기록](release-checklist.md)을 따릅니다.
